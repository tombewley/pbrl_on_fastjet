...
PARAMS=(
    ...
    "run.py fastjet.land pets=3 200 --wandb=1 --group=22-09-02_land --oracle=closing_and_shaping --features=default --sampler=ucb_nostd_norecency --schedule=1k_200_1_1 --model=net"
    "run.py fastjet.land pets=3 200 --wandb=1 --group=22-09-02_land --oracle=closing_and_shaping --features=default --sampler=ucb_nostd_norecency --schedule=1k_200_1_1 --model=tree=0"
    "run.py fastjet.land pets=3 200 --wandb=1 --group=22-09-02_land --oracle=closing_and_shaping --features=default --sampler=ucb_nostd_norecency --schedule=1k_200_1_1 --model=tree=4"
    "run.py fastjet.land pets=3 200 --wandb=1 --group=22-09-02_land --oracle=closing_and_shaping --features=default --sampler=ucb_nostd_norecency --schedule=1k_200_1_1 --model=tree=8"
    "run.py fastjet.land pets=3 200 --wandb=1 --group=22-09-02_land --oracle=closing_and_shaping --features=default --sampler=ucb_nostd_norecency --schedule=1k_200_1_1 --model=tree=12"
    ...
    "run.py fastjet.land pets=3 200 --wandb=1 --group=22-09-02_land --oracle=closing_and_shaping --features=default --sampler=uniform_recency --schedule=1k_200_1_1_sched --model=net"
    "run.py fastjet.land pets=3 200 --wandb=1 --group=22-09-02_land --oracle=closing_and_shaping --features=default --sampler=uniform_recency --schedule=1k_200_1_1_sched --model=tree=0"
    "run.py fastjet.land pets=3 200 --wandb=1 --group=22-09-02_land --oracle=closing_and_shaping --features=default --sampler=uniform_recency --schedule=1k_200_1_1_sched --model=tree=4"
    "run.py fastjet.land pets=3 200 --wandb=1 --group=22-09-02_land --oracle=closing_and_shaping --features=default --sampler=uniform_recency --schedule=1k_200_1_1_sched --model=tree=8"
    "run.py fastjet.land pets=3 200 --wandb=1 --group=22-09-02_land --oracle=closing_and_shaping --features=default --sampler=uniform_recency --schedule=1k_200_1_1_sched --model=tree=12"
)
