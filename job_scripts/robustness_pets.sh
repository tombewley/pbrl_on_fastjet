...
PARAMS=(
    ...
    "fastjet.land pets=2 200 --wandb=1 --group=robustness_pets_land --oracle=closing_and_shaping --features=default --sampler=uniform_recency --schedule=1k_200_1_1 --model=tree=10"
    "fastjet.land pets=4 200 --wandb=1 --group=robustness_pets_land --oracle=closing_and_shaping --features=default --sampler=uniform_recency --schedule=1k_200_1_1 --model=tree=10"
    "fastjet.land pets=5 200 --wandb=1 --group=robustness_pets_land --oracle=closing_and_shaping --features=default --sampler=uniform_recency --schedule=1k_200_1_1 --model=tree=10"
)
